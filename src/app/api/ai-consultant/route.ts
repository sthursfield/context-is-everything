...
<div style="display: flex; flex-direction: column; gap: 3px; margin: 4px 0;">
  <div style="display: flex; align-items: flex-start; padding: 6px; border: 1px solid #e0e0e0; border-radius: 6px; background: rgba(255, 255, 255, 0.3); backdrop-filter: blur(8px); gap: 12px;">
